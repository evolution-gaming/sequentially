  ...
  .jvmPlatform(
    ...
    configure = _.settings(
      ...
      libraryDependencies ++= Seq(
        ...
        "com.evolution" %% "akka-to-pekko-adapter-actor" % "0.0.6",
        "com.evolution" %% "akka-to-pekko-adapter-stream" % "0.0.6",
        "com.evolution" %% "akka-to-pekko-adapter-test-kit" % "0.0.6" % Test,
      ),
    ),
  )
  .jvmPlatform(
